...
//                    array_map("unlink", glob($path));
    ...
    public function regionHandle(){
        ...
        //http://www.zhongtai.com/index.php/Admin/Tools/region/op/add/parent_id/47494
        //http://www.zhongtai.com/index.php/Admin/Tools/region/parent_id/47494
        //echo $referurl;die;
        //$referurl = 'Admin/Tools/region',array('parent_id'=>'".$data['parent_id']."'))}';
        $referurl = "/index.php/Admin/Tools/region/parent_id/".$data['parent_id'];
        if(empty($id)){
