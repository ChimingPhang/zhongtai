        ...
        foreach ($store_arr as $storeKey => $storeVal) {
            ...
            foreach ($storeVal as $templateKey => $templateVal) {
                ...
                foreach ($templateVal as $goodsKey => $goodsVal) {
                    ...
                    $temp['volume'] = $goodsVal['volume'];
                    $temp['weight'] = $goodsVal['weight'];
...
//        $po = Db::query($sql);
     ...
     * @return false|\PDOStatement|string|\think\Collection
     */
    public function checkGoodsListShipping_car($goods_ids, $region_id)
    {
        $Goods = new Goods();
        $freightLogic = new FreightLogic();
        $freightLogic->setRegionId($region_id);
     ...
     * @throws TpshopException
     */
    public function getStoreFreight_car($goodsArr, $region_id)
    {
        $Goods = new Goods();
        $freightLogic = new FreightLogic();
        $freightLogic->setRegionId($region_id);
