        ...
        $modules = [
            [
                ...
                'privilege' => [
                    ...
                    'order'=>'订单中心','count'=>'统计报表','weixin'=>'微信管理','maintenance'=>'运营',
                    'dealers'=>'经销商','shipping'=>'运费管理'
//                    ,'marketing'=>'营销推广','tools'=>'插件工具','store'=>'店铺管理','distribut'=>'分销管理'
                ],
            ],
            [
                'name'  => 'seller', 'title' => '经销商后台', 'show' => 1,
                'privilege' => [
                    'goods'=>'商品管理','order'=>'订单管理','store'=>'经销商管理','charts'=>'统计报表'
//                    'finance'=>'财务管理','distribut'=>'分销管理','maintenance'=>'运营','promtion'=>'促销管理',
//                    'service'=>'售后服务','mesaage'=>'客服消息','seller'=>'账号管理',
                ]
            ],
            [
