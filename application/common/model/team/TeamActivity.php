...
class TeamActivity extends Model
{
    public function specGoodsPrice(){
        return $this->hasOne('app\common\model\SpecGoodsPrice','item_id','item_id')->bind(['price']);
    }
    public function goods(){
        return $this->hasOne('app\common\model\Goods','goods_id','goods_id')->bind(['shop_price']);
    }
