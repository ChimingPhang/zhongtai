...
return [
    ...
    'cache'                  => [
        ...
        'path'   => CACHE_PATH,
        // 缓存前缀
        'prefix' => '1e83124b9c4d00507da056f0fac68522',
        // 缓存有效期 0表示永久缓存
        'expire' => 0,
    ],
    'redis'                  => [
...
*/
    ...
    'ORDER_STATUS_DESC' => array(
     ...
     'ORDER_STATUS_DESCS' => array(
        'WAITPAY' => '1',//'待支付',
        'WAITSEND'=>'4',//'待发货',
        'WAITRECEIVE'=>'5',//'待收货',
        'WAITCCOMMENT'=> '2',//'待评价',
        'CANCEL'=> '6',//'已取消',
        'CANCEL_REFUND'=> '7', //'已取消&已退款',
        'FINISH'=> '3', //'已完成',
        'CANCELLED'=> '已作废',
        'OTHER' => '未知',
    ),
    ...
    'SEND_SCENE' => array(
        ...
        '8'=>array('拍卖开始提醒','尊敬的用户，您关注的商品"${goodsName}"即将开拍,请注意查收.','virtual_auction_sms_enable'),
        '9'=>array('客户预约试驾','${name}. ${sex}. 预约的 ${category_name}车','appointment_drive'),
        '10'=>array('客户预约拍卖','您预约的 ${goodsName}拍卖商品将在${time}开始拍卖,请准时参加,感谢您的支持','virtual_bookings_sms_enable'),
        '11'=>array('拍卖成功提醒','您参拍的 ${goodsName}拍卖商品已经拍成功,请在${time}前完成支付,过时将取消订单并扣除保证金','virtual_remind_sms_enable'),
        '12'=>array('拍卖失败提醒','您参拍的 ${goodsName}拍卖商品与您失之交臂,感谢您的支持','virtual_remind_sms_enable'),
    ),
	 ...
	 * */
	'weixin'=>array(
		'appid' => 'wx2c70b8756a813e94',
		'appsecret' => '26e42046f959440e96796d096c6d2b66',
		'mchid' => '1501781801',
		'key' => 'gTCxMrkBT8ZNTRpKvzxh3KYlveF9PlkA',
//        'notify_url' => 'http://mall.admin.zotye.com/Pay/wx_notify',
//        'go_url' => 'http://mall.zotye.com/orderok',
//        'back_url' => 'http://mall.zotye.com/orderfail',
        'notify_url' => 'http://admin.zhongtai.qiuart.com/Pay/wx_notify',
        'go_url' => 'http://zhongtai.qlzhx.cn/orderok',
        'back_url' => 'http://zhongtai.qlzhx.cn/orderfail',
	),
    ...
    //网站域名地址/微信支付等会用到
//    'APP_URL' => 'http://mall.admin.zotye.com/',
    'APP_URL' => 'http://admin.zhongtai.qiuart.com/',
    //文本编辑器图片跟地址
//    'FILE_URL'=> 'http://mall.admin.zotye.com/',
    'FILE_URL'=> 'http://admin.zhongtai.qiuart.com/',
    /**
     * 图片上传的配置
     */
     'picture_upload' => [
