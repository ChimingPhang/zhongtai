...
//        tpCache('shopping.auto_transfer_date');自动分销时间
        $distribut_set_by = M('config')->where("name", "distribut_set_by")->getField('value');
        $confirm_time_config = tpCache('shopping.auto_service_date');  //最终退货时间
        $this->assign('confirm_time_config', $confirm_time_config);
