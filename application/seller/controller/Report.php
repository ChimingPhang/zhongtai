...
class Report extends Base{
	...
	public function index(){
		...
		$sql .= " where add_time>$this->begin and add_time<$this->end and type = 1 and store_id=$this->store_id AND (pay_status=1 or pay_code='cod') and order_status in(1,2,4) and refund_status < 1 group by gap order by gap desc";
	...
	public function saleTop(){
		...
		$sql .=" where is_send = 1 and type = 1 and store_id=$this->store_id group by goods_id order by sale_amount DESC limit 100";
	...
	public function saleList(){
        $where = "o.add_time>$this->begin and o.add_time<$this->end and o.type = 1 and og.store_id=$this->store_id and (o.pay_status=1 or o.pay_code='cod') and o.order_status in(1,2,4) and og.is_send < 2 ";
