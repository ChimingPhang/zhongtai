...
class FreighLogic extends Model
{

    /**
     * 添加编辑模板
     */
    public function addEditFreighTemplate(){
...
//            $arrs['template_name']  = $template_name;
//            $arrs['type']  = $type;
//            $arrs['is_enable_default']  = $is_enable_default;
//            M('freight_template')->add($arrs);
        } else {
            //更新模板
            ...
            $arrs['type']  = $type;
            $arrs['is_enable_default']  = $is_enable_default;
            M('freight_template')->where(['template_id'=>$template_id])->save($arrs);
        }
